...
*Audio Effect* y *Output Mix* tienen su propia pantalla, descritas arriba.
*Volume Knob*, *Volume Button* y *Mute Toggle* comparten esta:
...
**La tecla dice "Sin destino" o "Sin conexión".** No hay destino configurado, o
Wave Link no está abierto. La tecla siempre dice qué le falta.

**La tecla parpadea al usarla.** El destino ya no existe — por ejemplo,
desconectaste ese micrófono. Abrí la configuración y elegí el destino de nuevo.
...
**Nada responde.** Revisá el log, en
...
[ROADMAP.md](ROADMAP.md), y los pasos para publicar en [RELEASE.md](RELEASE.md).
